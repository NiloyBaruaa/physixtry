    ...
    return (
        <div>
            <div className="card text-center md:text-left  flex flex-col lg:flex-row bg-base-100 shadow-xl md:mx-28 border m-10">
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions  justify-center">
                        <button className="btn btn-primary px-24 text-white border-none rounded-full text-xl font-semibold  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ..."><Link to="/physixtry/subject">Continue Courses</Link></button>
                    </div>
                </div>
            </div>
            <div className="card text-center md:text-left  flex flex-col lg:flex-row bg-base-100 shadow-xl md:mx-28 border m-10">
            ...
            <div className="card-body">
                    ...
                    <p className="text-2xl font-bold text-white">Experience The Best Education In Bangladesh In The Way You Never Learned Before</p>
                    <div className="card-actions  justify-center">
                        <button className="btn btn-primary px-24 text-white border-none rounded-full text-xl font-semibold  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 ..."><Link to="/physixtry/exams">Continue Exams</Link></button>
                    </div>
                </div>
                <figure>
                    <img className="mx-5 w-full"
          ...
          <h1 onClick={handleLogout} className='w-1/4 text-center mx-auto btn btn-primary'>Log Out</h1>
          </div>
