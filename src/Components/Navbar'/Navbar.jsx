...
const Navbar = () => {
    const navLinks =
        <>
            ...
            <NavLink className='px-5 btn border-none bg-white text-[#1e1b4b] hover:text-white hover:bg-[#1e1b4b]' to={'/physixtry/notifications'}>Notifications <small className="mb-6 text-red-700 ">NEW</small></NavLink>
